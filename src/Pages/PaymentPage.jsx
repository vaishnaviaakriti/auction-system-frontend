      ...
      <div className="container mx-auto px-4 py-8 text-white">
        ...
        <div className="flex justify-center"> {/* Centering wrapper */}
          <form onSubmit={handleSubmit} className="max-w-md">
            ...
            <div className="mb-4">
              <label className="block mb-1 text-black">Expiry Date:</label>
              <input
                type="text"
                name="expiryDate"
            ...
            <div className="mb-4">
              <label className="block mb-1 text-black">CVV:</label>
              <input
                type="text"
                name="cvv"
                value={formData.cvv}
            ...
            <div className="mb-4">
              <label className="block mb-1 text-black">Amount:</label>
              <input
                type="text"
                name="amount"
